...
# TAMBAH ENEMY, TAMBAH COLLIDERNYA, RANDOMIZE POSISINYA, FLIP GAMBARNYA, NUNGGU ROMY
    ...
    while True:  # main loop, what keeps the game running
        ...
        if menu == False:
            ...
            if (pygame.sprite.groupcollide(bird_group, ground_group, False, False, pygame.sprite.collide_mask) or
                    ...
                    pygame.sprite.groupcollide(bird_group, enemy_group, False, False, pygame.sprite.collide_mask)):# "mask" makes that only the pixels that have any color in the bird collide with the pixels of the floor or pipe
                # hit sound
